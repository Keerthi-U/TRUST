...
<div id="demo" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/mm.jpg" alt="Los Angeles">
      <div class="slide-overlay" style="background-color: #000000; opacity:0.2;"></div>	
      <div class="carousel-caption" data-animate-in="up">
        <h2 class="slide-text">Create A Fully Immersive Experience For Your Dream Audience		</h2>
        <div class="slide-content" style="font-size: 16px;">
			<p>Morbi tempus porta nunc <strong>pharetra quisque</strong> ligula imperdiet posuere<br />
			vitae felis proin sagittis leo ac tellus blandit sollicitudin <em>quisque</em> vitae placerat.</p>
		</div>
         <a class="slide-button button" href="#">
					Download now									
		 </a>
		 <a class="slide-button slide-button--second button" href="#">
										See More				
		</a>
      </div>   
    </div>
    <div class="carousel-item ">
      <img src="images/mm.jpg" alt="Chicago">
      <div class="slide-overlay" style="background-color: #000000; opacity:0.2;"></div>	
      <div class="carousel-caption caro">
         <h2  class="slide-text">Seamlessly Integrated Features</h2>
			<div class="slide-content" style="font-size: 16px;">
				<p>Support for portfolio, services, team members, and more. Support for portfolio, services, team members, and more.</p>
			</div>
		<a class="slide-button slide-button--second button" href="#">
			Get this theme now
		</a>
                       ...
                       <div class="testi ti-col">
                           <div class="testimonial">
                                   <div class="testimonial-content">
                                       ...
                                       <img src="image/testi1.jpg" class="testimonial-image">
                                       <h4 class="testimonial-name">Brian Dean</h4>
                                       <div class="testimonial-position">Bussiness owner </div>
                                 </div>
                             </div>
                        ...
                        <div class="testi ti-col">
                           <div class="testimonial">
                               <div class="testimonial-content">
                                    ...
                                    <img src="image/testi2.jpg" class="testimonial-image">
                                    <h4 class="testimonial-name">Ian Lewis</h4>
                                    <div class="testimonial-position">WEB CONSULTANT
                                   </div>
                                </div>
                            </div>
                        ...
                        <div class="testi ti-col">
                           <div class="testimonial">
                                   <div class="testimonial-content">
                                    ...
                                    <img src="image/testi3.jpg" class="testimonial-image">
                                    <h4 class="testimonial-name">Jessica White</h4>
                                    <div class="testimonial-position">BUSSINESS OWNER
                                   </div>
                                </div>
                          </div>
		...
		<div class="row">
            <div class="bloggg">
                    ...
                    <div class="blogg column-narrow col4"data-animate-in="up">
                     ...
                     <h2 class="blog-title"> Travel Tips for South Africa  </h2>
                     </div>
                     ...
                     <div class="blog-paragraph">
                        <p>Sed nec facilisis lacus. Aenean ullamcorper, ex sit amet
                            consectetur imperdiet, dui lorem eleifend dolor, non commodo
                            ipsum purus sed quam. Nullam eget maximus leo. Pellentesque 
                            ac tempor risus. In vestibulum orci arcu. Morbi in vehicula libero,
                            sollicitudin ornare felis. Aliquam vestibulum pulvinar dui</p>
                     </div>
                    
                      <button id="read-more"> Read-More</button>
                      <div class="post-comments"><a href="https://www.demos.machothemes.com/antreas/chinas-last-wild-bears/#comments">1</a></div>
                     ...
                     <div class="bolg-content">
                     <h2 class="blog-title"> China’s Last Wild Animals  </h2>
                     </div>
                     <div class="post-byline">
                        <div class="post-date">October 12, 2018</div>			
                    ...
                    <div class="bolg-content">
                    <h2 class="blog-title">Stories from Landlocked Lands  </h2>
                    </div>
                    <div class="post-byline">
                        <div class="post-date">October 12, 2018</div>			
